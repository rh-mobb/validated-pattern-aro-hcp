...
| [`AGENTS.md`](../AGENTS.md) | Source precedence; human vs agent docs |
| [`clusters/aro-virt/AGENTS.md`](../clusters/aro-virt/AGENTS.md) | Agent virt E2E (not MkDocs) |
